				...
				<div class="row event-grid-page">
						...
						<div class="dcare__event">
							<div class="event__thumb">
								<a href="event-details.html">
									<img src="images/event/mid-img-2/1.jpg" alt="event images">
								</a>
							</div>
							<div class="event__content">
								...
								<ul class="event__btn">
									...
									<li><a href="event-details.html">Learn More</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="dcare__event">
							...
							<div class="event__thumb">
								<a href="event-details.html">
									<img src="images/event/mid-img-2/2.jpg" alt="event images">
								</a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="dcare__event">
							<div class="event__thumb">
								<a href="event-details.html">
									<img src="images/event/mid-img-2/3.jpg" alt="event images">
								</a>
							</div>
							<div class="event__content">
								<div class="event__pub">
					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="dcare__event">
							<div class="event__thumb">
								<a href="event-details.html">
									<img src="images/event/mid-img-2/4.jpg" alt="event images">
								</a>
							</div>
							<div class="event__content">
								<div class="event__pub">
					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="dcare__event">
							...
							<div class="event__thumb">
								<a href="event-details.html">
									<img src="images/event/mid-img-2/5.jpg" alt="event images">
								</a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="dcare__event">
							<div class="event__thumb">
								<a href="event-details.html">
									<img src="images/event/mid-img-2/6.jpg" alt="event images">
								</a>
							</div>
							<div class="event__content">
								<div class="event__pub">
					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="dcare__event">
							<div class="event__thumb">
								<a href="event-details.html">
									<img src="images/event/mid-img-2/7.jpg" alt="event images">
								</a>
							</div>
							<div class="event__content">
								<div class="event__pub">
					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="dcare__event">
							...
							<div class="event__thumb">
								<a href="event-details.html">
									<img src="images/event/mid-img-2/8.jpg" alt="event images">
								</a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						<div class="dcare__event">
							<div class="event__thumb">
								<a href="event-details.html">
									<img src="images/event/mid-img-2/10.jpg" alt="event images">
								</a>
							</div>
							<div class="event__content">
								<div class="event__pub">
